...
export default function PersonCentredSoftwareConfigPage() {
  const { user } = useAuth();
  ...
  const handleSave = async () => {
    ...
    try {
      const payload = {
        ...
        integration_type: 'person_centred_software',
      ...
      <div className="max-w-4xl mx-auto px-4">
        <div className="mb-6">
          ...
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              <h1 className="text-3xl font-bold text-slate-900">Person Centred Software</h1>
              <p className="text-slate-600">Configure your PCS integration settings</p>
            </div>
          </div>
        </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Enable or disable the Person Centred Software integration</CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Enter your Person Centred Software API credentials</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  ...
                  />
                  <p className="text-xs text-slate-500">Your PCS API endpoint URL</p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  />
                  <p className="text-xs text-slate-500">Available in your PCS account settings</p>
                </div>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Configure how often data should sync with PCS</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-slate-500">
                    Manual sync allows you to control when data is sent to PCS
                  </p>
                </div>
              </CardContent>
            </Card>
