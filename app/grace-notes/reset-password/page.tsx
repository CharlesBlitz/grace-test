...
export default function GraceNotesResetPasswordPage() {
      ...
      <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white flex items-center justify-center px-4">
        <Card className="w-full max-w-md">
          ...
          <CardContent className="space-y-4">
            ...
            <Link href="/grace-notes/forgot-password" className="block">
              <Button className="w-full bg-emerald-600 hover:bg-emerald-700">
                Request New Reset Link
              </Button>
            </Link>

            <Link href="/grace-notes/login" className="block">
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="mt-2 space-y-2">
                  ...
                  <ul className="text-xs text-slate-600 space-y-1 mt-2">
                    {passwordStrength.feedback.map((feedback, index) => (
                      <li key={index} className={passwordStrength.isValid ? 'text-emerald-600' : ''}>
                        • {feedback}
                      </li>
                    ))}
                  </ul>
            ...
            <div className="text-center">
              <Link href="/grace-notes/login" className="text-sm text-slate-600 hover:underline">
                Back to Sign In
              </Link>
            </div>
          </form>
